...
```bash
python3 dippy_subnet/upload_model.py --hf_repo_id HF_REPO --wallet.name WALLET  --wallet.hotkey HOTKEY --config_template MODEL_CHAT_TEMPLATE --model_dir PATH_TO_MODEL   
```
